package br.spring.com.correiosapi.service;
...
//import br.spring.com.correiosapi.model.Endereco;
...
public class CepService {
	...
	//public CepService(@Value("${correiros.sigepweb.uri}") String sigepWebUri) {
	//	Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
	//	marshaller.setContextPath("br.spring.com.correiosapi");
